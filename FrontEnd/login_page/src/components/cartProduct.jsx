...
export default function CartProduct({ _id,productId,quantity}) {
	...
	const product_id=productId._id
	...
	const handleIncrement = () => {
        ...
        updateQuantityVal(newquantityVal,product_id);
	};
    ...
    const updateQuantityVal = (quantity,product_id) => {
        fetch(`http://localhost:8080/product/cart?update=${true}`, {
            method: 'POST',
            headers: {
